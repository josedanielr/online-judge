...
DATABASES = {
     'default': {
        ...
        'PORT': os.environ.get('SQL_DATABASE_PORT', '3306'),
        'OPTIONS': {
            'charset': 'utf8mb4',
...
PROBLEM_DATA_ROOT = '/dmoj/problems'
